      ...
      <div className="about">
        ...
        <div className="content-container">
          <div className="cards">
            ...
            <p className="text">
              It is optimized for adaptive thinking and reasoning. It is multi
              modal that can generate text from image.{" "}
            </p>
          </div>
          <div className="cards">
            ...
            <p className="text">
              By helping users understand the nutritional value of their meals
