...
const HomePage = () => {
  ...
  const [welcomeMessage, setWelcomeMessage] = useState(
    "Upload or take a snap of your food so I can analyze it"
  );
    ...
    <>
      ...
      <div className="home night-mode">
        <form onSubmit={handleSubmit} className="form-container">
          ...
          {switchButton ? (
            <button disabled={analyzing} type="button" onClick={newPhoto}>
              {analyzing ? "Analyzing..." : "Analyze new food"}
            </button>
          ) : (
            <button disabled={analyzing} className="analyze-bttn" type="submit">
              {analyzing ? "Analyzing..." : "Analyze my food"}
            </button>
          )}
