                ...
                <div className="app-body-container">      
                    ...
                    <div className="content-container">
                        ...
                        >
                            ...
                            <p className="text"><span>Cancer Prevention</span>: Some studies link high fiber intake, especially from whole grains and fruits, to lower risks of colorectal cancer, 
                                possibly due to improved digestion and reduced toxin exposure in the colon.
                            </p>
                            <p className="text">
                        ...
                        >
                            <h2>Carbs</h2>
                            <p className="text">
                            <span>Good carbs</span> are complex, unrefined carbohydrates found in whole grains, legumes, 
                            vegetables, and fruits. They are high in fiber and nutrients,
                            providing sustained energy, supporting digestion, and promoting heart health.
                            </p> 
                            <p className="text">
                            <span>Bad carbs</span> are refined carbohydrates, like sugary drinks, sweets, 
                            and processed snacks, low in fiber and nutrients. 
